...
def compare(user_score, computer_score):
  if user_score > 21 and computer_score > 21:
    ...
    return "Dealer win with the Blackjack T.T"
  elif user_score == 0:
    return "You win with the Blackjack! ^.^"
  elif user_score == computer_score:
    return f"It's a Draw"
  elif user_score > 21:
   return f"You lose T.T"
  elif computer_score > 21:
    return f"Dealer went over. You win! ^.^"
  elif user_score > computer_score :
    return f"You win! ^.^"
...
def blackjack():  
  ...
  while not game_over:
    ...
    print(f"Computer's first hand: {computer_card_list[0]}")
  ...
  print(f"Computer's final hand: {computer_card_list}, final socre: {computer_score}.")
