...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.quiz_text = self.canvas.create_text(150,125, text="Testing Text", font=("Arial", 20, "italic"), fill=THEME_COLOR, width=280)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.quiz_text, text = "퀴즈 게임이 종료되었습니다!")
